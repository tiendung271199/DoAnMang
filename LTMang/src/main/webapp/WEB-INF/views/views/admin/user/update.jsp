	  			  ...
	  			  <div class="row">
	  				<div class="col-md-12 panel-info">
			  			<div class="content-box-header panel-heading">
		  					<div class="panel-title ">Cập nhật thông tin người dùng</div>
			  			</div>
				  			...
				  			<div>
								...
								<div class="row">
									<div class="col-sm-12">
										...
										<a style="margin-left: 5px" href="${urlAdminUser}/doi-mat-khau/user-${user.id}" title="Đổi mật khẩu" class="btn btn-primary">Đổi mật khẩu</a>
