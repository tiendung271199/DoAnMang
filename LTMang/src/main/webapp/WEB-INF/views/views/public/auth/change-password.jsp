...
<div class="main-content fl-right">
	<div class="section" id="detail-blog-wp">
		<div class="section-head clearfix">
			<h3 class="section-title">Thông tin cá nhân | Đổi mật khẩu</h3>
		</div>
		<hr />
		<div class="section-detail">
			...
			<form action="${urlProfile}/doi-mat-khau" method="post">
				...
				<div>
					...
					<button type="button" onclick="back()" class="btn btn-primary">Trở về</button>
				</div>
			</form>
		</div>
	</div>
